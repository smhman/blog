...
export class WTFESM extends Post {
	...
	public keywords = ['javascript', 'esm', 'typescript', 'publish', 'package', 'npm', 'new stuff'];
	...
	public render(): JSX.Element {
		return (
			<>
				...
				<ExternalLink href="https://open.spotify.com/playlist/1LMNbk9NnmzHgheUaqo10B?si=932dd9310e4344cf">гэнгстащит - Playlist by Alika Milova</ExternalLink>: This playlist features fantastic old-school rap music.
				<ExternalLink href="https://open.spotify.com/playlist/2CwQnoCEqaooVF8PMIBcq7?si=e415dfb3f9794b40">Messed up music style - Playlist by sundei</ExternalLink>: A collection of my favorite songs with an eclectic mix of styles.
				<ExternalLink href="https://open.spotify.com/playlist/6DknRhS60ZMYLJqClGreW8?si=c458e92802624db1">SSF!! - Playlist by GV</ExternalLink>: A playlist dedicated to Joker Out's music.
				<ExternalLink href="https://open.spotify.com/playlist/1NaTLQR3u4d5AY02oMBtSO?si=38ce21aa8e3c44b3">rave🤙🏾 - Playlist by Alika Milova</ExternalLink>: Perfect for party vibes, including Russian party music.
